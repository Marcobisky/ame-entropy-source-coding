...
% output_file = 'markov_encoded_test.txt';

% For real
source_file = 'source.txt';
output_file = 'markov_encoded.txt';
...
% Write encoded_output.txt preserving spaces and newlines
fid = fopen(output_file, 'wb'); % Open in binary mode
fwrite(fid, encoded_output, 'char'); % Write preserving all characters
fclose(fid);
